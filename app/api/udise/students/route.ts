...
export async function GET(request: NextRequest) {
  ...
  const report = await loadUdiseChecklist(prisma, { includeStaff: false, student: { className: sp.get("className") || undefined, section: sp.get("section") || undefined, status: sp.get("status") || undefined } });
