...
export default async function LibraryPage() {
  ...
  const [report, canCatalog, canCopies, canImport, canCirculate, canPolicies, canCirculationReports, canStock] = await Promise.all([
    ...
    hasRolePermission(prisma, user.role, "MANAGE_LIBRARY_CATALOG"), hasRolePermission(prisma, user.role, "MANAGE_LIBRARY_COPIES"),
    hasRolePermission(prisma, user.role, "IMPORT_LIBRARY_CATALOG"), hasRolePermission(prisma, user.role, "VIEW_LIBRARY_CIRCULATION"),
    hasRolePermission(prisma, user.role, "MANAGE_LIBRARY_POLICIES"), hasRolePermission(prisma, user.role, "VIEW_LIBRARY_CIRCULATION_REPORTS"),
    hasRolePermission(prisma, user.role, "VIEW_LIBRARY_STOCK_VERIFICATION")
  ]);
