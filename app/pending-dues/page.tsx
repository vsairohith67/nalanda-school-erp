      ...
      <section className="card">
        ...
        <div className="table-wrap">
          <table>
            <thead>
              <tr>
                <th>Adm No</th><th>Student</th><th>Father</th><th>Class</th><th>Phone</th><th>Annual</th><th>Discount</th><th>After Discount</th><th>Paid</th>
                <th>T1 Paid</th><th>T1 Due</th><th>T2 Paid</th><th>T2 Due</th><th>T3 Paid</th><th>T3 Due</th><th>T4 Paid</th><th>T4 Due</th><th>Total Pending</th><th>Status</th><th>Remarks</th><th>Communication</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row) => row ? (
                <tr key={row.admissionNo}>
                  ...
                  <td>
                    {user.role === "VIEWER" ? maskPhone(row.phone1) : row.phone1}
                    {row.phone2 ? ` / ${user.role === "VIEWER" ? maskPhone(row.phone2) : row.phone2}` : ""}
                  </td>
