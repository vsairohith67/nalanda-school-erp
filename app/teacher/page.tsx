...
export default async function TeacherPage() {
  ...
  return <div className="page">
    ...
    <section className="card card-pad"><h3>My Report Cards</h3><p>View report cards only inside your exact timetable class and section scope. Academic Integrity v1.1 denies Teacher rubric grades, overall grades, submission, imports, batch mutations, correction, and issue actions.</p>{permissionSetCan(permissions,"VIEW_REPORT_CARDS")?<Link className="button" href="/teacher/report-cards">Open Read-only Report Cards</Link>:<p>Report-card access is not enabled for this account.</p>}</section>
