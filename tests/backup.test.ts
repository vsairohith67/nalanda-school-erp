...
describe("full backup", () => {
  it("creates the expected backup structure", () => {
    ...
    expect(backup.metadata.counts).toEqual({
      ...
      biometricBridges: 0,
      biometricDevices: 0,
      biometricStaffMappings: 0,
      biometricAttendancePolicies: 0,
      biometricIngestBatches: 0,
      biometricRawPunches: 0,
      biometricSequenceGaps: 0,
      biometricReconciliations: 0,
      biometricCorrections: 0,
      biometricAuditEvents: 0,
      ocrDocuments: 0,
      ocrJobs: 0,
      ocrPages: 0,
      ocrFieldCandidates: 0,
      ocrSubmissions: 0,
      ocrWorkflowEvents: 0,
      ...
      studentDepartureRequests: 0,
      studentDepartureConsentEvidence: 0,
      studentStandingDepartureAuthorizations: 0,
      studentGatePasses: 0,
      ...
      transportRoutes: 0,
      transportStops: 0,
      transportRouteStops: 0,
      transportStudentAssignments: 0,
      transportAuditEvents: 0,
      cafeteriaCatalogItems: 0,
      cafeteriaMenus: 0,
