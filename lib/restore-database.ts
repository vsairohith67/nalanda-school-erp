...
async function restoreIntoDatabase(
  ...
  const result: RestoreResult = {
    ...
    certificateRequestCharges: emptyEntityResult(),
    certificateBulkBatches: emptyEntityResult(),
    certificateIssueArtifacts: emptyEntityResult(),
