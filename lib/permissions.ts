...
export const PERMISSIONS = [
  ...
  "VIEW_BIOMETRIC_ATTENDANCE",
  "MANAGE_BIOMETRIC_DEVICES",
  "MANAGE_BIOMETRIC_STAFF_MAPPINGS",
  "APPROVE_BIOMETRIC_STAFF_MAPPINGS",
  "RECONCILE_BIOMETRIC_ATTENDANCE",
  "APPROVE_BIOMETRIC_ATTENDANCE",
  "VIEW_BIOMETRIC_ATTENDANCE_REPORTS",
  "EXPORT_BIOMETRIC_ATTENDANCE_REPORTS",
  "VIEW_OWN_STAFF_ATTENDANCE",
  "REQUEST_OWN_ATTENDANCE_CORRECTION",
  "VIEW_STAFF_LEAVE",
  "APPLY_STAFF_LEAVE",
  "MANAGE_STAFF_LEAVE",
  "APPROVE_STAFF_LEAVE",
  ...
  "PUBLISH_CLASSWORK",
  "CLOSE_CLASSWORK",
  "REVIEW_CLASSWORK_SUBMISSIONS",
  "VIEW_CLASSWORK_AGGREGATES",
  "EXPORT_CLASSWORK_AGGREGATES",
  "VIEW_OWN_CLASSWORK",
  "SUBMIT_OWN_CLASSWORK",
  "UPLOAD_CLASSWORK_ATTACHMENTS",
  "DOWNLOAD_CLASSWORK_ATTACHMENTS",
  "MANAGE_CLASSWORK_RECOVERY",
  "VIEW_ADMISSIONS",
  "MANAGE_ADMISSION_ENQUIRIES",
  "MANAGE_ADMISSION_APPLICATIONS",
  "REVIEW_ADMISSION_APPLICATIONS",
  "DECIDE_ADMISSIONS",
  "CONVERT_ADMISSIONS",
  "MANAGE_ADMISSION_DOCUMENTS",
  ...
  "VIEW_PAYSLIP_REQUESTS",
  "PREPARE_PAYSLIP_REQUEST",
  "UPLOAD_PAYSLIP_DOCUMENT",
  "ISSUE_PAYSLIP_DOCUMENT",
  "REPLACE_PAYSLIP_DOCUMENT",
  "VIEW_PAYSLIP_REQUEST_AUDIT",
  "MANAGE_PAYSLIP_MONTH_AVAILABILITY",
  "VIEW_OWN_PAYSLIP_REQUESTS",
  "REQUEST_OWN_PAYSLIP",
  "VIEW_EXAMS",
  "MANAGE_EXAMS",
  ...
  "PRINT_REPORTS",
  "VIEW_RECEIPT_AUDIT",
  "VIEW_FAMILY_COLLECTIONS",
  "CREATE_FAMILY_COLLECTIONS",
  "CONFIRM_FAMILY_COLLECTIONS",
  "ISSUE_FAMILY_RECEIPTS",
  "VIEW_FAMILY_RECONCILIATION",
  "EXPORT_FAMILY_COLLECTIONS",
  "VIEW_OWN_FAMILY_RECEIPTS",
  "MANAGE_RECEIPTS",
  "COMMUNICATE_PARENT",
  "EXPORT_PAYMENTS",
  "EXPORT_REPORTS",
  ...
  "EXPORT_TRANSPORT_REPORTS",
  "VIEW_OWN_CHILD_TRANSPORT",
  "VIEW_CAFETERIA",
  "MANAGE_CAFETERIA_CATALOG",
  "MANAGE_CAFETERIA_MENUS",
  "MANAGE_CAFETERIA_ENROLLMENTS",
  "RECORD_CAFETERIA_PARTICIPATION",
  "VIEW_CAFETERIA_REPORTS",
  "EXPORT_CAFETERIA_REPORTS",
  "VIEW_OWN_CHILD_CAFETERIA",
  "VIEW_CASH_BOOK",
  "MANAGE_CASH_BOOK",
  "SUBMIT_CASH_BOOK",
  "APPROVE_CASH_BOOK",
  ...
  "VIEW_EVENT_MEDIA",
  "CREATE_EVENT_MEDIA_ALBUMS",
  "UPLOAD_EVENT_MEDIA",
  "REVIEW_EVENT_MEDIA",
  "MANAGE_MEDIA_PUBLICATION_CONSENT",
  "APPROVE_EVENT_MEDIA",
  "PUBLISH_EVENT_MEDIA",
  "ARCHIVE_EVENT_MEDIA",
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { permission: "VIEW_BIOMETRIC_ATTENDANCE", label: "View biometric attendance", description: "View normalized device health, punches and reconciliation without biometric templates or secrets." },
      { permission: "MANAGE_BIOMETRIC_DEVICES", label: "Govern biometric devices", description: "Register, rotate or revoke a bridge and its allow-listed device registry. Super Admin only." },
      { permission: "MANAGE_BIOMETRIC_STAFF_MAPPINGS", label: "Prepare biometric Staff mappings", description: "Prepare an explicit opaque device-user to active Staff mapping when separately delegated." },
      { permission: "APPROVE_BIOMETRIC_STAFF_MAPPINGS", label: "Approve biometric Staff mappings", description: "Approve a prepared, conflict-free mapping with effective dates." },
      { permission: "RECONCILE_BIOMETRIC_ATTENDANCE", label: "Prepare biometric reconciliation", description: "Prepare deterministic Staff attendance outcomes from immutable punch evidence." },
      { permission: "APPROVE_BIOMETRIC_ATTENDANCE", label: "Approve biometric attendance", description: "Approve reconciliation into the existing Staff attendance record without payroll impact." },
      { permission: "VIEW_BIOMETRIC_ATTENDANCE_REPORTS", label: "View biometric reports", description: "View bounded private Staff attendance, exception, backlog and device-health reports." },
      { permission: "EXPORT_BIOMETRIC_ATTENDANCE_REPORTS", label: "Export biometric reports", description: "Export bounded, formula-safe and no-store biometric attendance reports." },
      { permission: "VIEW_OWN_STAFF_ATTENDANCE", label: "View own Staff attendance", description: "View only the authenticated Staff member's linked attendance and correction history." },
      { permission: "REQUEST_OWN_ATTENDANCE_CORRECTION", label: "Request own attendance correction", description: "Submit a reasoned correction request against immutable original punch evidence." }
    ]
  },
  {
    id: "student-safe-exit",
    title: "Student Safe Exit",
    permissions: [
      { permission: "REQUEST_STUDENT_DEPARTURE", label: "Request Student departure", description: "Create an early-departure request only within exact authorised Student scope." },
      { permission: "RECORD_PARENT_CONSENT", label: "Record Parent consent", description: "Record governed linked-Guardian consent evidence; a phone attempt alone is never consent." },
      { permission: "APPROVE_STUDENT_DEPARTURE", label: "Approve Student departure", description: "Approve a consent-verified request as Principal or Director leadership." },
      { permission: "EMERGENCY_OVERRIDE_STUDENT_DEPARTURE", label: "Emergency departure override", description: "Use the restricted, re-authenticated safeguarding override with complete evidence." },
      { permission: "VERIFY_GATE_PASS", label: "Verify gate pass", description: "Verify an opaque signed, unexpired and unused Student gate pass." },
      { permission: "COMPLETE_STUDENT_CHECKOUT", label: "Complete Student checkout", description: "Complete verified handover and consume a gate pass exactly once." },
      { permission: "RECORD_STUDENT_RETURN", label: "Record Student return", description: "Append a return-to-campus presence event without rewriting attendance." },
  ...
  },
  {
    ...
    permissions: [
      ...
      { permission: "VIEW_FAMILY_COLLECTIONS", label: "View family collections", description: "Review governed family collections; Viewer receives suppressed aggregates only." },
      { permission: "CREATE_FAMILY_COLLECTIONS", label: "Create family collection previews", description: "Resolve eligible Students and prepare reviewed family allocation previews." },
      { permission: "CONFIRM_FAMILY_COLLECTIONS", label: "Confirm family collections", description: "Post an exact reviewed family collection once with paise reconciliation and stale-plan checks." },
      { permission: "ISSUE_FAMILY_RECEIPTS", label: "Issue family receipts", description: "Issue one consolidated family receipt with child-specific allocation sections." },
      { permission: "VIEW_FAMILY_RECONCILIATION", label: "View family reconciliation", description: "Review instrument, allocation, Ledger, Cash Book and replacement reconciliation." },
      { permission: "EXPORT_FAMILY_COLLECTIONS", label: "Export family collections", description: "Export bounded masked family-collection reconciliation records." },
      { permission: "VIEW_OWN_FAMILY_RECEIPTS", label: "View own family receipts", description: "Parent access to issued receipts only for actively linked children." },
  ...
  },
  {
    ...
    permissions: [
      ...
      { permission: "VIEW_PAYSLIP_REQUESTS", label: "View payslip request queue", description: "View Staff payslip requests and protected-document status without receiving document passwords." },
      { permission: "PREPARE_PAYSLIP_REQUEST", label: "Prepare payslip requests", description: "Accept or assign externally prepared payslip requests without final issue authority." },
      { permission: "UPLOAD_PAYSLIP_DOCUMENT", label: "Upload payslip documents", description: "Upload validated synthetic or externally prepared PDF source documents for protection and review." },
      { permission: "ISSUE_PAYSLIP_DOCUMENT", label: "Issue payslip documents", description: "Critically re-authenticate, approve and finally issue a protected Staff payslip document." },
      { permission: "REPLACE_PAYSLIP_DOCUMENT", label: "Replace payslip documents", description: "Create governed corrected versions without overwriting the former protected document." },
      { permission: "VIEW_PAYSLIP_REQUEST_AUDIT", label: "View payslip request audit", description: "View request, version, password-reveal, view and download audit history." },
  ...
  {
    id: "optionalOperations",
    title: "Optional Operations Foundations",
    permissions: [
      { permission: "VIEW_TRANSPORT", label: "View Transport", description: "View the optional Transport workspace and privacy-minimal roster." },
      { permission: "MANAGE_TRANSPORT_VEHICLES", label: "Manage Transport vehicles", description: "Create and update capacity-controlled vehicle references." },
      { permission: "MANAGE_TRANSPORT_ROUTES", label: "Manage Transport routes", description: "Create and update routes, ordered stops and approved timing references." },
      { permission: "MANAGE_TRANSPORT_ASSIGNMENTS", label: "Manage Transport assignments", description: "Create effective-dated Student pickup and drop assignments with retained history." },
      { permission: "VIEW_TRANSPORT_REPORTS", label: "View Transport reports", description: "View privacy-minimal route capacity and roster reports." },
      { permission: "EXPORT_TRANSPORT_REPORTS", label: "Export Transport reports", description: "Download formula-safe Transport reports without home addresses or private Staff details." },
      { permission: "VIEW_OWN_CHILD_TRANSPORT", label: "View linked-child Transport", description: "Parent linked-child-only read access to route and approved stop timing references." },
      { permission: "VIEW_CAFETERIA", label: "View Cafeteria", description: "View the optional Cafeteria catalog, menus and serving roster." },
      { permission: "MANAGE_CAFETERIA_CATALOG", label: "Manage Cafeteria catalog", description: "Create and update active or inactive meal items without finance posting." },
      { permission: "MANAGE_CAFETERIA_MENUS", label: "Manage Cafeteria menus", description: "Create date-bound menus and item availability." },
      { permission: "MANAGE_CAFETERIA_ENROLLMENTS", label: "Manage Cafeteria enrollment", description: "Create effective-dated Student opt-in history without collecting health records." },
      { permission: "RECORD_CAFETERIA_PARTICIPATION", label: "Record Cafeteria participation", description: "Record one bounded meal order or participation event without money mutation." },
      { permission: "VIEW_CAFETERIA_REPORTS", label: "View Cafeteria reports", description: "View privacy-minimal opt-in and serving reports." },
      { permission: "EXPORT_CAFETERIA_REPORTS", label: "Export Cafeteria reports", description: "Download formula-safe Cafeteria reports without health or payment data." },
      { permission: "VIEW_OWN_CHILD_CAFETERIA", label: "View linked-child Cafeteria", description: "Parent linked-child-only read access to opt-in and meal participation." }
    ]
  },
  {
    id: "notices",
  ...
  {
    id: "classwork",
    title: "Classwork and Secure Submissions",
    permissions: [
      { permission: "VIEW_CLASSWORK", label: "View classwork", description: "View governed classwork within exact leadership or Teacher object scope." },
      { permission: "MANAGE_CLASSWORK", label: "Manage classwork drafts", description: "Create versioned drafts only within exact academic-year, class, section, and subject scope." },
      { permission: "PUBLISH_CLASSWORK", label: "Publish classwork", description: "Publish an immutable instruction version after audience and attachment-recovery checks pass." },
      { permission: "CLOSE_CLASSWORK", label: "Close or archive classwork", description: "Close submissions or archive preserved classwork without hard deletion." },
      { permission: "REVIEW_CLASSWORK_SUBMISSIONS", label: "Review submissions", description: "Open scoped submissions, append feedback, return for revision, and record review." },
      { permission: "VIEW_CLASSWORK_AGGREGATES", label: "View classwork aggregates", description: "View privacy-minimised completion and exception totals without surveillance ranking." },
      { permission: "EXPORT_CLASSWORK_AGGREGATES", label: "Export classwork aggregates", description: "Export bounded, formula-safe and privacy-suppressed aggregate CSV only." },
      { permission: "VIEW_OWN_CLASSWORK", label: "View own classwork", description: "View published classwork only for self or the active linked-child Parent context." },
      { permission: "SUBMIT_OWN_CLASSWORK", label: "Submit own classwork", description: "Create versioned text/file work only for self or the active linked-child Parent context." },
      { permission: "UPLOAD_CLASSWORK_ATTACHMENTS", label: "Upload private classwork attachments", description: "Upload bounded validated files to opaque private storage; this never creates a public URL." },
      { permission: "DOWNLOAD_CLASSWORK_ATTACHMENTS", label: "Download authorised classwork attachments", description: "Use authenticated private/no-store retrieval after exact object ownership checks." },
      { permission: "MANAGE_CLASSWORK_RECOVERY", label: "Verify classwork attachment recovery", description: "Create encrypted asset backups and record two isolated byte-verified restores before release." }
    ]
  },
  {
    id: "admissions",
    title: "Admissions and Enquiry CRM",
    permissions: [
      { permission: "VIEW_ADMISSIONS", label: "View admissions workspace", description: "View authorised enquiries and applications with role-safe fields." },
      { permission: "MANAGE_ADMISSION_ENQUIRIES", label: "Manage enquiries", description: "Create minimal enquiries and append bounded follow-ups or school visits." },
      { permission: "MANAGE_ADMISSION_APPLICATIONS", label: "Manage applications", description: "Issue invitation-only applications and support completeness or information requests." },
      { permission: "REVIEW_ADMISSION_APPLICATIONS", label: "Review assigned applications", description: "Review an exact assigned application without gaining broader admissions access." },
      { permission: "DECIDE_ADMISSIONS", label: "Decide admissions", description: "Record reasoned waitlist, offer, decline, withdrawal, expiry or final approval decisions." },
      { permission: "CONVERT_ADMISSIONS", label: "Convert approved admissions", description: "Perform exactly-once Student, Guardian and enrollment conversion without fees or activation." },
      { permission: "MANAGE_ADMISSION_DOCUMENTS", label: "Manage admission documents", description: "Review configured, validated documents through private no-store retrieval." },
      { permission: "VIEW_ADMISSION_REPORTS", label: "View admission reports", description: "View privacy-safe aggregate demand, funnel, duration and conversion totals." },
      { permission: "EXPORT_ADMISSION_REPORTS", label: "Export admission reports", description: "Export bounded formula-safe admissions aggregates without raw IDs or private notes." },
      { permission: "MANAGE_ADMISSION_RETENTION", label: "Review admission retention", description: "Preview governed archive or anonymisation candidates without hard deletion." }
    ]
  },
  {
    id: "exams",
    ...
    permissions: [
      ...
      { permission: "VIEW_EXAM_TIMETABLE", label: "View examination timetables", description: "View exact-cohort timetable drafts, publication evidence, and version history." },
      { permission: "MANAGE_EXAM_TIMETABLE", label: "Manage examination timetables", description: "Create and edit exact-cohort examination timetable drafts with conflict validation." },
      { permission: "PUBLISH_EXAM_TIMETABLE", label: "Publish examination timetables", description: "Publish, replace, withdraw, or archive validated examination timetable versions." },
      { permission: "VIEW_OWN_ATTENDANCE", label: "View linked child attendance", description: "View official attendance only for the active opaque linked-child context." },
      { permission: "VIEW_OWN_EXAM_TIMETABLE", label: "View linked child examination timetable", description: "View currently published timetables only for the active opaque linked-child context." },
  ...
  {
    id: "academicCalendar",
    title: "Events, Holidays and Academic Calendar",
    permissions: [
      { permission: "VIEW_CALENDAR_MANAGEMENT", label: "View calendar management", description: "View governed academic-day totals, event drafts, impact previews and immutable publication history." },
      { permission: "MANAGE_ACADEMIC_CALENDAR", label: "Manage operational calendar", description: "Prepare draft working, non-working, half, vacation and special-working day classifications." },
      { permission: "REVIEW_ACADEMIC_CALENDAR", label: "Review operational calendar", description: "Review working-day totals, attendance impact, examination conflicts and version differences." },
      { permission: "PUBLISH_ACADEMIC_CALENDAR", label: "Publish operational calendar", description: "Publish, replace, withdraw or archive an approved operational calendar version." },
      { permission: "PUBLISH_EMERGENCY_CLOSURE", label: "Publish emergency closure", description: "Create a reasoned emergency-closure classification without sending external messages or rewriting attendance." },
      { permission: "MANAGE_SCHOOL_EVENTS", label: "Manage school events", description: "Create and edit bounded internal informational event drafts with exact audiences." },
      { permission: "REVIEW_SCHOOL_EVENTS", label: "Review school events", description: "Inspect event content, examination references and every resolved audience before publication." },
      { permission: "PUBLISH_SCHOOL_EVENTS", label: "Publish school events", description: "Publish, replace, withdraw or archive approved informational event versions." },
      { permission: "PROPOSE_SCHOOL_EVENTS", label: "Propose assigned-cohort events", description: "Allow a Teacher to create a non-publishing draft only for an exact active timetable cohort." },
      { permission: "VIEW_STAFF_CALENDAR", label: "View Staff calendar", description: "View published school, authorised Staff and exact assigned-cohort calendar entries." },
      { permission: "VIEW_OWN_CALENDAR", label: "View linked-child calendar", description: "View only published school-wide and active linked-child cohort calendar entries." },
      { permission: "EXPORT_ACADEMIC_CALENDAR", label: "Export academic calendar", description: "Download bounded, formula-safe management calendar summaries without actor IDs or private notes." }
    ]
  },
  {
    id: "teacherAnalytics",
  ...
  },
  {
    ...
    title: "Event Media",
    permissions: [
      { permission: "VIEW_EVENT_MEDIA", label: "View event media", description: "Open the private leadership album and media review workspace." },
      { permission: "CREATE_EVENT_MEDIA_ALBUMS", label: "Create event albums", description: "Create private-by-default governed event albums." },
      { permission: "UPLOAD_EVENT_MEDIA", label: "Upload event photos", description: "Upload validated originals to private storage and create safe local derivatives." },
      { permission: "REVIEW_EVENT_MEDIA", label: "Review event photos", description: "Review captions, manual Student associations and publication eligibility." },
      { permission: "MANAGE_MEDIA_PUBLICATION_CONSENT", label: "Manage media consent", description: "Record or revoke explicit, dated photo-publication consent without inferring it from enrolment or messaging consent." },
      { permission: "APPROVE_EVENT_MEDIA", label: "Approve event media", description: "Approve reviewed media only when every governed publication check passes." },
      { permission: "PUBLISH_EVENT_MEDIA", label: "Publish event media", description: "Explicitly publish an approved album to its approved audience; public output remains feature-flagged off by default." },
      { permission: "ARCHIVE_EVENT_MEDIA", label: "Archive event media", description: "Soft-archive albums and retain original bytes and audit history." },
      { permission: "VIEW_OWN_EVENT_MEDIA", label: "View linked-child event media", description: "Read only approved Parent-visible media linked to the signed-in Guardian's children." }
    ]
  },
  {
    id: "parent-meetings",
...
const principalPermissions = new Set<CanonicalPermission>([
  ...
  "VIEW_CLASSWORK", "MANAGE_CLASSWORK", "PUBLISH_CLASSWORK", "CLOSE_CLASSWORK", "REVIEW_CLASSWORK_SUBMISSIONS", "VIEW_CLASSWORK_AGGREGATES", "EXPORT_CLASSWORK_AGGREGATES", "UPLOAD_CLASSWORK_ATTACHMENTS", "DOWNLOAD_CLASSWORK_ATTACHMENTS", "MANAGE_CLASSWORK_RECOVERY",
  "VIEW_ADMISSIONS", "MANAGE_ADMISSION_ENQUIRIES", "MANAGE_ADMISSION_APPLICATIONS", "REVIEW_ADMISSION_APPLICATIONS", "DECIDE_ADMISSIONS", "CONVERT_ADMISSIONS", "MANAGE_ADMISSION_DOCUMENTS", "VIEW_ADMISSION_REPORTS", "EXPORT_ADMISSION_REPORTS", "MANAGE_ADMISSION_RETENTION",
  ...
  "VIEW_EXAM_CONFIGURATION", "MANAGE_EXAM_CONFIGURATION", "ACTIVATE_EXAM_SCHEMES", "ASSIGN_EXAM_TEACHERS", "VIEW_EXAM_TIMETABLE", "MANAGE_EXAM_TIMETABLE", "PUBLISH_EXAM_TIMETABLE",
  "VIEW_CALENDAR_MANAGEMENT", "MANAGE_ACADEMIC_CALENDAR", "REVIEW_ACADEMIC_CALENDAR", "PUBLISH_ACADEMIC_CALENDAR", "PUBLISH_EMERGENCY_CLOSURE", "MANAGE_SCHOOL_EVENTS", "REVIEW_SCHOOL_EVENTS", "PUBLISH_SCHOOL_EVENTS", "VIEW_STAFF_CALENDAR", "EXPORT_ACADEMIC_CALENDAR",
  "VIEW_EXAM_MODERATION", "MODERATE_EXAM_MARKS", "REOPEN_EXAM_MARK_SHEETS", "RUN_EXAM_CALCULATIONS", "LOCK_EXAM_CALCULATIONS",
  "VIEW_OWN_EXAM_MARKS", "ENTER_ASSIGNED_EXAM_MARKS", "SUBMIT_ASSIGNED_EXAM_MARKS", "REQUEST_EXAM_MARK_CORRECTION",
  ...
  ,"VIEW_BIOMETRIC_ATTENDANCE", "APPROVE_BIOMETRIC_STAFF_MAPPINGS", "APPROVE_BIOMETRIC_ATTENDANCE", "VIEW_BIOMETRIC_ATTENDANCE_REPORTS", "EXPORT_BIOMETRIC_ATTENDANCE_REPORTS"
  ...
  ,"VIEW_TRANSPORT", "VIEW_TRANSPORT_REPORTS", "EXPORT_TRANSPORT_REPORTS"
  ,"VIEW_CAFETERIA", "VIEW_CAFETERIA_REPORTS", "EXPORT_CAFETERIA_REPORTS"
]);
...
const adminPermissions = new Set<CanonicalPermission>([
  ...
  "VIEW_HOMEWORK", "MANAGE_HOMEWORK", "PUBLISH_HOMEWORK", "ARCHIVE_HOMEWORK", "VIEW_HOMEWORK_REPORTS", "EXPORT_HOMEWORK_REPORTS",
  "VIEW_ADMISSIONS", "MANAGE_ADMISSION_ENQUIRIES", "MANAGE_ADMISSION_APPLICATIONS", "MANAGE_ADMISSION_DOCUMENTS", "VIEW_ADMISSION_REPORTS", "EXPORT_ADMISSION_REPORTS", "MANAGE_ADMISSION_RETENTION",
  "VIEW_EXAMS", "MANAGE_EXAMS", "CONFIGURE_EXAM_ASSESSMENTS", "VIEW_EXAM_REPORTS", "EXPORT_EXAM_REPORTS",
  "VIEW_REPORT_CARDS", "MANAGE_REPORT_CARD_TEMPLATES", "MANAGE_REPORT_CARD_BATCHES", "VIEW_REPORT_CARD_REPORTS", "EXPORT_REPORT_CARD_REPORTS",
  ...
  "RUN_BACKUP"
  ,"VIEW_STUDENT_ATTENDANCE", "MANAGE_STUDENT_ATTENDANCE", "SUBMIT_STUDENT_ATTENDANCE", "LOCK_STUDENT_ATTENDANCE", "VIEW_STUDENT_ATTENDANCE_REPORTS"
  ,"REQUEST_STUDENT_DEPARTURE", "RECORD_PARENT_CONSENT", "VERIFY_GATE_PASS", "COMPLETE_STUDENT_CHECKOUT", "RECORD_STUDENT_RETURN", "VIEW_LIVE_CAMPUS_ROSTER", "VIEW_DEPARTURE_AUDIT"
  ,"VIEW_STAFF_ATTENDANCE", "MANAGE_STAFF_ATTENDANCE", "SUBMIT_STAFF_ATTENDANCE", "LOCK_STAFF_ATTENDANCE", "VIEW_STAFF_ATTENDANCE_REPORTS"
  ,"VIEW_STAFF_LEAVE", "APPLY_STAFF_LEAVE", "MANAGE_STAFF_LEAVE", "APPROVE_STAFF_LEAVE", "VIEW_STAFF_LEAVE_REPORTS"
  ,"VIEW_SUBSTITUTES", "MANAGE_SUBSTITUTES", "ASSIGN_SUBSTITUTES", "CONFIRM_SUBSTITUTES", "VIEW_SUBSTITUTE_REPORTS"
...
const viewerPermissions = new Set<CanonicalPermission>([
  ...
  "VIEW_HOMEWORK_REPORTS",
  "VIEW_ADMISSION_REPORTS",
  "VIEW_CLASSWORK", "VIEW_CLASSWORK_AGGREGATES",
  "VIEW_EXAM_REPORTS",
  "VIEW_REPORT_CARD_REPORTS",
  "VIEW_STAFF"
...
const eventMediaLeadershipPermissions: CanonicalPermission[] = [
  "VIEW_EVENT_MEDIA", "CREATE_EVENT_MEDIA_ALBUMS", "UPLOAD_EVENT_MEDIA", "REVIEW_EVENT_MEDIA",
  "MANAGE_MEDIA_PUBLICATION_CONSENT", "APPROVE_EVENT_MEDIA", "PUBLISH_EVENT_MEDIA", "ARCHIVE_EVENT_MEDIA"
];
for (const permission of eventMediaLeadershipPermissions) {
