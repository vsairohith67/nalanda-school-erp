...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { permission: "EDIT_PAYMENTS", label: "Edit payments", description: "Review or correct payment entries." },
      { permission: "CANCEL_PAYMENTS", label: "Cancel payments", description: "Cancel payment rows with audit history." },
      ...
      { permission: "MANAGE_RECEIPTS", label: "Manage receipt notes", description: "Mark receipt numbers cancelled in the audit tool." },
