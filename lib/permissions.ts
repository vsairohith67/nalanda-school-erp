...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { permission: "CANCEL_PAYMENTS", label: "Cancel final receipts", description: "Director/Super Admin only: cancel every component of a final receipt with reason and audit history." },
