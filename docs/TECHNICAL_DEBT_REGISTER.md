...
| RC-TD-07 | R7 stacked metric labels, dense marks allocation and 12 mm signature clearance did not meet final table-priority direction | Corrected in R8 with measured single-line cells, dense academic-table priority, combined VI-X trait/grade, adaptive chart footprint and 15 mm signing clearance; final digital approval and physical printing remain pending |
