...
Logical backup version 43 includes all six Event Media metadata tables and excludes image bytes. Private bytes have a separate encrypted `event-media:asset-backup` flow. That command:
