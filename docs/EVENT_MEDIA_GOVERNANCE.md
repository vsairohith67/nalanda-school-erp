...
Current logical backup version 43 continues to include all six Event Media metadata tables and excludes image bytes. Private bytes have a separate encrypted `event-media:asset-backup` flow. That command:
