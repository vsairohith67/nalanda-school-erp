...
| Accountant | `CONDITIONAL_GO` | Implemented finance, expenses, budget, Cash Book, misc income, books and allowed charge collection | FIN-2A is resolved; refunds/gateway/payroll/employee self-service are outside this go |
