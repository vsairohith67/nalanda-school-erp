...
Transport and Cafeteria V1.5 software foundations are cleared and remain governed `DEFAULT-OFF`; this does not mean Nalanda operates either service. V2 remains AI lessons/videos with Teacher approval and no automatic Student publication.
