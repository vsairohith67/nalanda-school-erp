...
The report-card V1 release-candidate gate is currently limited to Classes I-X. KG/LKG/UKG is an implemented but default-off V1.5 foundation and is excluded from V1 completeness. The R4.2 packs are superseded pending the complete Classes I-X correction register; no replacement pack or physical acceptance exists yet. See `docs/RELEASE_CANDIDATE_CHECKLIST.md`.
