...
| Workflow correctness | Local database is not migration-baselined for production/cloud | Medium | SQLite local app with Prisma migrations/db push history | Before cloud/Postgres migration, compare schema and create a tested migration plan. |
