...
| Classes I-X R8 digital and physical acceptance | Final eight-page colour and true-monochrome packs approved digitally and physically on A4, including the governed one-generation photocopy check; `REPORT_PRINT_ACCEPTANCE_CLEARED` |
