    ...
    <div className={`app-shell ${sidebarCollapsed ? "sidebar-collapsed" : ""} ${mobileNavOpen ? "mobile-nav-open" : ""}`}>
      ...
      <aside className="sidebar" id="mobile-navigation">
        ...
        <nav className="nav" aria-label="Main navigation">
          ...
          {user.role === "TEACHER" ? <Link href="/teacher/marks" className={pathname.startsWith("/teacher/marks") ? "active" : ""} aria-current={pathname.startsWith("/teacher/marks") ? "page" : undefined} onClick={() => setMobileNavOpen(false)}><ClipboardCheck size={17} aria-hidden /><span>Marks</span></Link> : null}
