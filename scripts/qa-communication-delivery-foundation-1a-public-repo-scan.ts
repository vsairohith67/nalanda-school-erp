...
const allowedRootFiles = new Set([".env.example", "middleware.ts", "package.json", "pnpm-lock.yaml", "deploy/portable/compose.yml", "next.config.ts", "tsconfig.tools-qa-support.json"]);
