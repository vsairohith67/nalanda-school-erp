...
const allowedRootFiles = new Set(["apps/nalanda-biometric-bridge/package.json","apps/nalanda-cross-platform/package.json","middleware.ts","package.json","pnpm-lock.yaml","Dockerfile","deploy/portable/Caddyfile","next.config.ts","tsconfig.tools-qa-support.json","pnpm-workspace.yaml"]);
