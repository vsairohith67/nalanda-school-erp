...
const allowedRootFiles = new Set(["middleware.ts","package.json","pnpm-lock.yaml","Dockerfile","deploy/portable/Caddyfile","next.config.ts","tsconfig.tools-qa-support.json","pnpm-workspace.yaml"]);
