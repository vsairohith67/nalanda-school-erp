...
const expected = { baseline: { students: 0, activeEnrollments: 0, payments: 0, collected: 0 }, users: 4, roleAssignments: 4, activeSuperAdmins: 1, backupVersion: 44, operationalCheckDefinitions: 13 } as const;
