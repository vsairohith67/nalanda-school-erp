...
async function main() {
  ...
  try {
    ...
    invariant(logical.metadata.backupVersion === 46 && logical.parentMeetings.length >= 1_015 && logical.parentMeetingNotes.length >= 5, `${prefix}_LOGICAL_BACKUP_INVALID`);
